    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (calendarStart != null && calendarEnd != null) {
            if (dateCal[Calendar.DAY_OF_YEAR] == calendarStart[Calendar.DAY_OF_YEAR] && dateCal[Calendar.YEAR] == calendarStart[Calendar.YEAR]) {
                val shape = (ContextCompat.getDrawable(context!!, R.drawable.calendar_start_day) as LayerDrawable?)!!
                ...
                var shape = (ContextCompat.getDrawable(context!!, R.drawable.calendar_middle_day) as LayerDrawable?)!!
                (shape.findDrawableByLayerId(R.id.dateShapeItem) as GradientDrawable).setColor(calendarData?.selectedColor!!)
                shape.findDrawableByLayerId(R.id.dateShapeItem).alpha = 20
                view.findViewById<View>(R.id.cellView).background = shape
                if (position % 7 == 0) {
                    shape = ContextCompat.getDrawable(context!!, R.drawable.calendar_start_day) as LayerDrawable
                    assert(shape != null)
                    (shape.findDrawableByLayerId(R.id.dateShapeItem) as GradientDrawable).setColor(calendarData?.selectedColor!!)
                    shape.findDrawableByLayerId(R.id.dateShapeItem).alpha = 20
                    view.findViewById<View>(R.id.cellView).background = shape
                ...
                if ((position + 1) % 7 == 0) {
                    shape = ContextCompat.getDrawable(context!!, R.drawable.calendar_end_day) as LayerDrawable
                    assert(shape != null)
                    (shape.findDrawableByLayerId(R.id.dateShapeItem) as GradientDrawable).setColor(calendarData?.selectedColor!!)
                    shape.findDrawableByLayerId(R.id.dateShapeItem).alpha = 20
                    view.findViewById<View>(R.id.cellView).background = shape
                ...
                val shape = (ContextCompat.getDrawable(context!!, R.drawable.calendar_end_day) as LayerDrawable?)!!
                (shape.findDrawableByLayerId(R.id.dateShapeItem) as GradientDrawable).setColor(calendarData?.selectedColor!!)
                shape.findDrawableByLayerId(R.id.dateShapeItem).alpha = 20
                view.findViewById<View>(R.id.cellView).background = shape
            }
        ...
        if (calendarStart != null && dateCal[Calendar.DAY_OF_YEAR] == calendarStart[Calendar.DAY_OF_YEAR] && currentDate[Calendar.MONTH] == dateCal[Calendar.MONTH] && dateCal[Calendar.YEAR] == calendarStart[Calendar.YEAR]) {
            val shape = (ContextCompat.getDrawable(context!!, R.drawable.calendar_selected_day) as LayerDrawable?)!!
